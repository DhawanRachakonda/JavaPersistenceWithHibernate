...
public class App {
	...
	private static void listBills(Session session) {
		...
		for(BillingDetails bill : billList) {
			...
			else if(bill instanceof BillingDetails){
				System.out.println("Bank Account : "+((BillingDetails) bill).getSwift());
			}
		}
	}
	...
	public static void main(String[] args) {
		 ...
		 /*session.getTransaction().begin();
		 CreditCard c = new CreditCard("Sai","1ss777554789", "SBI", "574sdad","1124358855", "07", "2020");
		 BillingDetails b = new BillingDetails("Ravi","1ss777554789", "SBI", "574sdad");
		 session.save(c);
		 session.save(b);
