...
public class App 
{
    ...
    public static void main( String[] args )
    {
    	...
    	contactList.add("Dhawan");
    	contactList.add("Akhul");
    	contactList.add("Badri");
    	contactList.add("Arun");
    	contactList.add("Karthik");
    	User u = new User(new Address("Brindhavan", "HYD", "500020",contactList));
    	session.persist(u);
