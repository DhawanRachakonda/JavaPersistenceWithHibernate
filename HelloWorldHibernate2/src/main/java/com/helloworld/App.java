...
public class App {
	...
	public static void listMessages() {
		...
		List<Message> messageList = session.createCriteria(Message.class)
				.setProjection(Projections.projectionList().add(Property.forName("id")).add(Property.forName("text")))
				.setResultTransformer(new AliasToBeanConstructorResultTransformer(Message.class.getConstructors()[0]))
				.list();
